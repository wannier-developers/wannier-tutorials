...
module load QuantumESPRESSO/5.3-intel-2017b
...
mkdir $WORK_DIR/scf_IrRep
cp $WORK_DIR/scf_IrRep.in $WORK_DIR/scf_IrRep
cd $WORK_DIR/scf_IrRep
srun pw.x < scf_IrRep.in > scf_IrRep.out
cp -r $WORK_DIR/scf_IrRep $SLURM_SUBMIT_DIR
cd $WORK_DIR
